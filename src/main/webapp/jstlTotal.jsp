...
<body>
	...
	<hr>
	<h3>set - 간단한 선언, out - 출력</h3>
	<c:set var="product1" value="<h2>사과</h2>" />
	<c:set var="product2" value="딸기" />
	...
	<h3>forEach: 배열 출력 varStatus 내부의 값을 반복</h3>
	<ul>
	...
	<h3>if - 간단한 조건만 가능. if~else는 choose로 구현</h3>
